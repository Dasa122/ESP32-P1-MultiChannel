...
#include "src/assets/CRC16.h"

#include "src/assets/HTML.H"
#include "src/assets/AAA_MENUPAGE.h"
#include "src/assets/AAA_HOMEPAGE.h"
#include "src/assets/PORTAL_HTML.h"
#include "src/assets/REPORT.H"
